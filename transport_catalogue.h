...
namespace transport_system {
    ...
    class TransportCatalogue
    {
        public:
            ...
            const std::vector<std::string>& GiveRequestDataReadAccess() const {return request_data__;}
            ...
            void PushRequestData(const std::string& value) {request_data__.push_back(value);}
        ...
        private:
            ...
            std::vector<std::string> request_data__;
